# World Institute for Action Learning | [wial.org](http://wial.org)

Any breadcrumbs that will make it easy for people to get a sense of the nonprofit.  
[https://wial.org](https://wial.org): Main  
[https://wial-usa.org](https://wial-usa.org/): Example of US chapter  
[https://wialnigeria.org](https://wialnigeria.org): Example of Nigeria chapter
...
### **eLearning Platform \- Provided only as informational, we aren’t building this \- UC6 to 9 are for REFERENCE ONLY**
